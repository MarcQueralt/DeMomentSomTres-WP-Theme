<?php
/**
 * DeMomentSomTres theme functions and definitions based on 
...
if (!function_exists('st_registerstyles')) {
    ...
    function st_registerstyles() {
        // DeMomentSomTres - deprecated - inici
        ...
        $stylesheets .= wp_enqueue_style('theme', get_stylesheet_directory_uri() . '/style.css', 'skeleton', $version, 'screen, projection');
        ...
        /* DeMomentSomTres Adaptacio per incloure fonts de google inici */
        $stylesheets = dmst_afegir_fonts_stylesheets($stylesheets);
        /* DeMomentSomTres Adaptacio per incloure fonts de google final */
...
if (!function_exists('skeleton_setup')):
    ...
    function skeleton_setup() {
        ...
        register_nav_menus(array(
            'primary' => __('Primary Navigation', 'demomentsomtres'),
        ));

        // Make theme available for translation
        // Translations can be filed in the /languages/ directory
        load_theme_textdomain('demomentsomtres', get_template_directory() . '/languages');
        ...
        register_default_headers(array(
            'berries' => array(
                ...
                'description' => __('Berries', 'demomentsomtres')
            ),
            'cherryblossom' => array(
                'url' => '%s/images/headers/cherryblossoms.jpg',
                'thumbnail_url' => '%s/images/headers/cherryblossoms-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Cherry Blossoms', 'demomentsomtres')
            ),
            'concave' => array(
                'url' => '%s/images/headers/concave.jpg',
                'thumbnail_url' => '%s/images/headers/concave-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Concave', 'demomentsomtres')
            ),
            'fern' => array(
                'url' => '%s/images/headers/fern.jpg',
                'thumbnail_url' => '%s/images/headers/fern-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Fern', 'demomentsomtres')
            ),
            'forestfloor' => array(
                'url' => '%s/images/headers/forestfloor.jpg',
                'thumbnail_url' => '%s/images/headers/forestfloor-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Forest Floor', 'demomentsomtres')
            ),
            'inkwell' => array(
                'url' => '%s/images/headers/inkwell.jpg',
                'thumbnail_url' => '%s/images/headers/inkwell-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Inkwell', 'demomentsomtres')
            ),
            'path' => array(
                'url' => '%s/images/headers/path.jpg',
                'thumbnail_url' => '%s/images/headers/path-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Path', 'demomentsomtres')
            ),
            'sunset' => array(
                'url' => '%s/images/headers/sunset.jpg',
                'thumbnail_url' => '%s/images/headers/sunset-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Sunset', 'demomentsomtres')
            )
        ));
    }
...
if (!function_exists('skeleton_continue_reading_link')) {
    ...
    function skeleton_continue_reading_link() {
        return ' <a href="' . get_permalink() . '">' . __('Continue reading <span class="meta-nav">&rarr;</span>', 'demomentsomtres') . '</a>';
    }
...
if (!function_exists('st_widgets_init')) {
    ...
    function st_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Posts Widget Area', 'demomentsomtres'),
            'id' => 'primary-widget-area',
            'description' => __('Shown only in Blog Posts, Archives, Categories, etc.', 'demomentsomtres'),
        ...
        register_sidebar(array(
            'name' => __('Pages Widget Area', 'demomentsomtres'),
            'id' => 'secondary-widget-area',
            'description' => __('Shown only in Pages', 'demomentsomtres'),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        register_sidebar(array(
            'name' => __('First Footer Widget Area', 'demomentsomtres'),
            'id' => 'first-footer-widget-area',
            'description' => __('The first footer widget area', 'demomentsomtres'),
        ...
        register_sidebar(array(
            'name' => __('Second Footer Widget Area', 'demomentsomtres'),
            'id' => 'second-footer-widget-area',
            'description' => __('The second footer widget area', 'demomentsomtres'),
            'before_widget' => '<div class="%1$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        register_sidebar(array(
            'name' => __('Third Footer Widget Area', 'demomentsomtres'),
            'id' => 'third-footer-widget-area',
            'description' => __('The third footer widget area', 'demomentsomtres'),
            'before_widget' => '<div class="%1$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        register_sidebar(array(
            'name' => __('Fourth Footer Widget Area', 'demomentsomtres'),
            'id' => 'fourth-footer-widget-area',
            'description' => __('The fourth footer widget area', 'demomentsomtres'),
            'before_widget' => '<div class="%1$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        if (class_exists('bbPress')) {
            register_sidebar(array(
                'name' => __('Forum Sidebar', 'demomentsomtres'),
                'id' => 'bbpress-widget-area',
                'description' => __('Sidebar displayed in forum', 'demomentsomtres'),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
                'before_title' => '<h3 class="widget-title">',
                'after_title' => '</h3>',
        ...
        if (class_exists('jigoshop')) {
            register_sidebar(array(
                'name' => __('Jigoshop Sidebar', 'demomentsomtres'),
                'id' => 'shop-widget-area',
                'description' => __('Sidebar displayed in Jigoshop pages', 'demomentsomtres'),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
                'before_title' => '<h3 class="widget-title">',
                'after_title' => '</h3>',
...
if (!function_exists('st_comments')) :
            ...
            <div id="comment-<?php comment_ID(); ?>" class="single-comment clearfix">
                ...
                <div class="comment-meta commentmetadata">
                    <?php if ($comment->comment_approved == '0') : ?>
                        <em><?php _e('Comment is awaiting moderation', 'demomentsomtres'); ?></em> <br />
                    <?php endif; ?>
                    <h6><?php echo __('By', 'demomentsomtres') . ' ' . get_comment_author_link() . ' ' . get_comment_date() . '  -  ' . get_comment_time(); ?></h6>
                    <?php comment_text() ?>
                    <?php edit_comment_link(__('Edit comment', 'demomentsomtres'), '  ', ''); ?>
                    <?php comment_reply_link(array_merge($args, array('reply_text' => __('Reply', 'demomentsomtres'), 'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>
                </div>
            </div>
            <!-- </li> -->
            <?php
    ...
    if (!function_exists('skeleton_posted_on')) :
        ...
        function skeleton_posted_on() {
            printf(__('<span class="%1$s">Posted on</span> %2$s <span class="meta-sep">by</span> %3$s', 'demomentsomtres'), 'meta-prep meta-prep-author', sprintf('<a href="%1$s" title="%2$s" rel="bookmark"><span class="entry-date">%3$s</span></a>', get_permalink(), esc_attr(get_the_time()), get_the_date()
                    ), sprintf('<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>', get_author_posts_url(get_the_author_meta('ID')), sprintf(esc_attr__('View all posts by %s', 'demomentsomtres'), get_the_author()), get_the_author()
                    )
            );
        }
    ...
    if (!function_exists('skeleton_posted_in')) :
        ...
        function skeleton_posted_in() {
            ...
            if ($tag_list) {
                $posted_in = __('This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'demomentsomtres');
            } elseif (is_object_in_taxonomy(get_post_type(), 'category')) {
                $posted_in = __('This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'demomentsomtres');
            } else {
                $posted_in = __('Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'demomentsomtres');
            }
...
// DeMomentSomTres - Modificacio presentacio del logo - inici
//        function st_logo() {
...
//        }
// DeMomentSomTres - Modificacio presentacio del logo - final
        function st_logo() {
            // Displays H1 or DIV based on whether we are on the home page or not (SEO)
            $heading_tag = ( is_home() || is_front_page() ) ? 'h1' : 'div';
            if (of_get_option('use_logo_image')) {
                $class = "graphic";
                $prefix_text = '<span class="site-title-ocult">';
                $sufix_text = '</span>';
                $imatge = '<img src="' . of_get_option('header_logo') . '"/>';
            } else {
                $class = "text";
                $prefix_text = "";
                $sufix_text = "";
            ...
            // echo of_get_option('header_logo')
            $st_logo = '<' . $heading_tag . ' id="site-title" class="' . $class . '"><a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name', 'display')) . '">';
            $st_logo .= $imatge;
            $st_logo .= $prefix_text . get_bloginfo('name') . $sufix_text;
    ...
    if (!function_exists('logostyle')) {
        ...
        function logostyle() {
            if (of_get_option('use_logo_image')) {
// DeMomentSomTres - Desactivar logo imatge - inici            
...
// DeMomentSomTres - Desactivar logo imatge - final                
            }
        }
...
// The Footer
// DeMomentSomTres modificat per afegir els peus
        ...
        function st_footer() {
            ...
            echo '<a class="demomentsomtres" href="http://www.demomentsomtres.com" title="DeMomentSomTres Comunicaci&oacute; Digital">Web, posicionament SEO i Comunicaci&oacute; Digital DeMomentSomTres Comunicaci&oacute; 3.0</a>';
            echo '<a class="themeauthor" href="http://www.simplethemes.com" title="WordPress Themes">Theme based on Simple Themes</a></div>';
        }
...
// bbPress
    ...
    /**
     * Registrar els stylesheets necessaris per incorporar les fonts de google
     * @param type $stylesheet La crida dels stylesheets
     * @return type La crida dels stylesheets amb les adaptacions corresponents
     */
    function dmst_afegir_fonts_stylesheets($stylesheet) {
        $t = array();
        $a = of_get_option('body_typography');
        $t[] = $a['face'];
        $a = of_get_option('h1_typography');
        $t[] = $a['face'];
        $a = of_get_option('h2_typography');
        $t[] = $a['face'];
        $a = of_get_option('h3_typography');
        $t[] = $a['face'];
        $a = of_get_option('h4_typography');
        $t[] = $a['face'];
        $a = of_get_option('h5_typography');
        $t[] = $a['face'];
        if (in_array('arimo', $t)):
            $stylesheet.=wp_enqueue_style('font-google-arimo', 'http://fonts.googleapis.com/css?family=Arimo:400italic,400,700', '', '20120614');
        endif;
        if (in_array('opensans', $t)):
            $stylesheet.=wp_enqueue_style('font-google-opensans', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,300,600,600italic', '', '20120614');
        endif;
        if (in_array('permanent', $t)):
            $stylesheet.=wp_enqueue_style('font-google-permanent', 'http://fonts.googleapis.com/css?family=Permanent+Marker', '', '20120614');
        endif;
        if (in_array('josefin', $t)):
            $stylesheet.=wp_enqueue_style('font-google-josefin', 'http://fonts.googleapis.com/css?family=Josefin+Sans:600,300,100,100italic,300italic,600italic', '', '20120614');
        endif;
        if (in_array('italiana', $t)):
            $stylesheet.=wp_enqueue_style('font-google-italiana', 'http://fonts.googleapis.com/css?family=Italiana', '', '20120614');
        endif;
        if (in_array('questrial', $t)):
            $stylesheet.=wp_enqueue_style('font-google-questrial', 'http://fonts.googleapis.com/css?family=Questrial', '', '20120614');
        endif;
        if (in_array('bangers', $t)):
            $stylesheet.=wp_enqueue_style('font-google-bangers', 'http://fonts.googleapis.com/css?family=Bangers', '', '20120614');
        endif;
        if (in_array('portlligat', $t)):
            $stylesheet.=wp_enqueue_style('font-google-portlligat', 'http://fonts.googleapis.com/css?family=Port+Lligat+Slab', '', '20120614');
        endif;
    ...
    /**
     * Incorpora la font google que es desitgi a la llista d'opcions
     * @param array $llista les fonts tal com les entrega options-sanitize
     * @return array la llista modificada per a que inclogui les fonts addicionals
     */
    function demomentsomtres_afegir_google_fonts($llista) {
        $l = array(
