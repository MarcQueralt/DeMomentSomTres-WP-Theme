<?php if ( comments_open() ) : ?><div id="reviews"><?php 
	...
	comment_form(array(
		...
		'comment_notes_after' => '',
		'fields' => array(
			'author' => '<p class="comment-form-author">' . '<label for="author">' . __( 'Name','demomentsomtres' ) . '</label> ' . '<span class="required">*</span>' .
			            '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" /></p>',
			'email'  => '<p class="comment-form-email"><label for="email">' . __( 'Email','demomentsomtres' ) . '</label> ' . '<span class="required">*</span>' .
		...
		'comment_field' => '
			...
			<p class="comment-form-comment"><label for="comment">' . _x( 'Your Review', 'noun', 'demomentsomtres' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>'
