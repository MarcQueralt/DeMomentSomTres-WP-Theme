...
if (!function_exists('optionsframework_add_page')) {
    ...
    function optionsframework_add_page() {
        ...
        // DeMomentSomTres - Theme adapt to wordpress.org
        ...
        $of_page = add_theme_page(__('Theme Options','demomentsomtres'), __('Theme Options','demomentsomtres'), 'edit_theme_options', 'options-framework', 'optionsframework_page');
        // DeMomentSomTres - Theme adapt to wordpress.org
                ...
                <div id="optionsframework" class="postbox">
                    <form action="options.php" method="post">
                        ...
                        <div id="optionsframework-submit">
                            <input type="submit" class="button-primary" name="update" value="<?php esc_attr_e('Save Options', 'demomentsomtres'); ?>" />
                            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e('Restore Defaults', 'demomentsomtres'); ?>" onclick="return confirm( '<?php print esc_js(__('Click OK to reset. Any theme settings will be lost!', 'demomentsomtres')); ?>' );" />
                            <div class="clear"></div>
                        </div>
                    </form>
                </div> <!-- / #container -->
...
function optionsframework_validate($input) {
    ...
    if (isset($_POST['reset'])) {
        add_settings_error('options-framework', 'restore_defaults', __('Default options restored.', 'demomentsomtres'), 'updated fade');
    ...
    if (isset($_POST['update'])) {
        ...
        add_settings_error('options-framework', 'save_options', __('Options saved.', 'demomentsomtres'), 'updated fade');
        return $clean;
    }
...
function optionsframework_adminbar() {
    ...
    $wp_admin_bar->add_menu(array(
        'parent' => 'appearance',
        'id' => 'of_theme_options',
        'title' => __('Theme Options', 'demomentsomtres'),
